...
def _auto_backend() -> str:
    ...
    # the matching guard in testo/harness/agentic_harness/tools/graphify/tool.py:_assert_backend_allowed
    # and in the REPL /scan handler (testo/repl.py).
...
def _assert_backend_allowed(backend: str) -> None:
    ...
    if backend == "gemini":
        print(
            ...
            "[graphify] Re-enable by editing testo/harness/agentic_harness/tools/graphify/tool.py "
...
class GraphifyTool(BaseTool):
    ...
    async def execute(self, arguments: GraphifyArgs, context: ToolExecutionContext) -> ToolResult:
        ...
        try:
            ...
            # MiniMax is added via testo/harness/agentic_harness/tools/graphify/with_minimax.py — a launcher
