...
# This file: <repo>/infrastructure/agentic-harness/agentic_harness/registry/tool_registry.py
#   parents[0]=registry/  parents[1]=agentic_harness/  parents[2]=agentic-harness/
#   parents[3]=infrastructure/  parents[4]=<repo>
...
REGISTERED_TOOLS: dict[str, ToolDefinition] = {
    "graphify": ToolDefinition(
        name="graphify",
        source_path=Path("scripts/graphify/tool.py"),
