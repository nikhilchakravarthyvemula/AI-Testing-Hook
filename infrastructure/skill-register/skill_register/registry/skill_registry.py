...
# This file: <repo>/infrastructure/skill-register/skill_register/registry/skill_registry.py
#   parents: [0]=registry/ [1]=skill_register/ [2]=skill-register/ [3]=infrastructure/ [4]=<repo>
