"""db-schema — top-level content-extractor for database schemas.
...
Env gating: TARGET_CODEBASE is required (same as graphify). Without it,
this writes a skipped bundle and exits 0.
"""
...
REPO_ROOT = _HERE.parents[2]   # content-extractor/ → context-layer/ → repo
