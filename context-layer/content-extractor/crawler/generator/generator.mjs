...
//
// Usage: node context-layer/content-extractor/crawler/generator/generator.mjs
...
by \`context-layer/content-extractor/crawler/generator/generator.mjs\`. Regenerated each time you run
\`npm run all\` from \`context-layer/content-extractor/crawler\` — local edits will be overwritten.
...
From \`context-layer/content-extractor/crawler\`:
...
\`\`\`bash
cd context-layer/content-extractor/crawler
npm run all
\`\`\`
`);
