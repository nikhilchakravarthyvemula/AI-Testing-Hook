...
Wraps `NextJSAppExtractor` from `_lib/testing_agent/context_layer/sources/codebase/extractors/frontend/nextjs_app.py`.

- **Source id:** `nextjs-app`
...
```bash
npm run extract -- ONLY=nextjs-app
```
