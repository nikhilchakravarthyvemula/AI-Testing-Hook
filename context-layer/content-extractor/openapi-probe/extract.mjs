...
//
// Output:
//   output/openapi-probe/raw.json       — every spec we fetched (verbatim)
//   output/openapi-probe/bundle.json    — distilled per-endpoint records
//
...
const OUT_DIR        = path.join(REPO_ROOT, 'output', 'openapi-probe');
...
async function main() {
  ...
  const bundle = {
    ...
    extractedAt: new Date().toISOString(),
    extractedBy: 'context-layer/content-extractor/openapi-probe/extract.mjs',
